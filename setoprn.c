...
int u[]={1,2,3,4,5,6,7,8,9},size=9; //Universal set Declaration
...
void main()
 {
	...
	struct bit b[9]={0}; //	"	"	  all places of b
	struct bit c[9]={0}; // "	"	  all places of c
	int x,y,i;
...
void insert(struct bit a[],int n)//insertion of sets
 {
	int i,d,j;
